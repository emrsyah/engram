...
const SECTIONS: { title: string; shortcuts: { keys: string[]; label: string }[] }[] = [
  {
    ...
    shortcuts: [
      ...
      { keys: ["3"], label: "Go to Tasks" },
      { keys: ["4"], label: "Go to Board" },
      { keys: ["5"], label: "Go to Timeline" },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: [mod, "Z"], label: "Undo last deletion" },
    ],
  },
  {
    title: "Board",
    shortcuts: [
      { keys: ["F"], label: "Toggle focus pin on selected item" },
